...
def build_start_group(gui, left_layout):
    ...
    gui.f5_clone_mode_combo = QComboBox()
    gui.f5_clone_mode_combo.addItem("Clone new voice", "new")
    gui.f5_clone_mode_combo.addItem("Use saved clone voice", "saved")
    gui.f5_clone_mode_combo.currentIndexChanged.connect(gui.on_f5_clone_mode_changed)
    gui.f5_saved_voice_combo = QComboBox()
    gui.f5_saved_voice_combo.currentIndexChanged.connect(gui.on_selected_voice_changed)
    gui.f5_ref_audio_edit = QLineEdit()
    gui.f5_ref_audio_edit.setPlaceholderText("Reference audio for F5 voice clone")
    gui.f5_browse_ref_audio_btn = QPushButton("Browse")
    gui.f5_browse_ref_audio_btn.clicked.connect(gui.browse_f5_ref_audio)
    gui.f5_clone_name_edit = QLineEdit()
    gui.f5_clone_name_edit.setPlaceholderText("Clone voice name (used if saved)")
    gui.f5_ref_text_edit = QTextEdit()
    gui.f5_ref_text_edit.setPlaceholderText("Optional reference text. If empty, CapCap will auto-transcribe with Whisper (Vietnamese).")
    ...
    gui.detail_voice_panel = QWidget()
    detail_voice_layout = QVBoxLayout(gui.detail_voice_panel)
    detail_voice_layout.setContentsMargins(0, 0, 0, 0)
    detail_voice_layout.setSpacing(8)
    detail_voice_layout.addWidget(QLabel("Detail voice mode"))
    detail_voice_layout.addWidget(gui.f5_clone_mode_combo)
    gui.f5_saved_voice_label = QLabel("Saved clone voice")
    detail_voice_layout.addWidget(gui.f5_saved_voice_label)
    detail_voice_layout.addWidget(gui.f5_saved_voice_combo)
    gui.f5_new_voice_panel = QWidget()
    f5_new_voice_layout = QVBoxLayout(gui.f5_new_voice_panel)
    f5_new_voice_layout.setContentsMargins(0, 0, 0, 0)
    f5_new_voice_layout.setSpacing(8)
    f5_new_voice_layout.addWidget(QLabel("Clone voice name"))
    f5_new_voice_layout.addWidget(gui.f5_clone_name_edit)
    f5_audio_row = QHBoxLayout()
    f5_audio_row.setContentsMargins(0, 0, 0, 0)
    f5_audio_row.setSpacing(8)
    f5_audio_row.addWidget(gui.f5_ref_audio_edit, 1)
    f5_audio_row.addWidget(gui.f5_browse_ref_audio_btn)
    f5_new_voice_layout.addWidget(QLabel("Reference audio"))

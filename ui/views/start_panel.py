...
def build_start_group(gui, left_layout):
    ...
    background_wrapper_layout.addWidget(QLabel("Padding:"), 1, 0)
    background_wrapper_layout.addWidget(gui.subtitle_background_padding_spin, 1, 1)
    background_wrapper_layout.addWidget(QLabel("Color:"), 2, 0)
    background_wrapper_layout.addWidget(gui.subtitle_background_color_btn, 2, 1)
    background_wrapper_layout.addWidget(QLabel("Opacity:"), 3, 0)
    background_wrapper_layout.addWidget(gui.subtitle_bg_alpha_spin, 3, 1)

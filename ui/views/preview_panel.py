...
def build_preview_panel(gui):
    ...
    gui.timeline_subtitle_toggle_btn = QPushButton("Text")
    ...
    gui.timeline_subtitle_toggle_btn.toggled.connect(lambda checked: gui.timeline.set_track_visibility("text", checked))

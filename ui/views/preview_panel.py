...
def build_preview_panel(gui):
    ...
    controls_layout.addWidget(gui.blur_add_btn)
    ...
    preview_audio_layout.addWidget(QLabel("Audio"))
    preview_audio_layout.addWidget(gui.preview_audio_track_combo)
    ...
    transport_row.addLayout(controls_layout)
    transport_row.addLayout(preview_audio_layout, 1)
    ...
    timeline_header_layout.addWidget(gui.voice_timing_sync_label)
    timeline_header_layout.addWidget(gui.voice_timing_sync_combo)
